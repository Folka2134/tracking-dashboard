          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:grid-rows-2 lg:ml-10 rounded-xl">
            ...
            <div className="flex flex-col w-64 justify-end bg-[#56C2E6] rounded-t-xl rounded-b-2xl relative">
              ...
              <div className="flex flex-col lg:h-48 bg-[#1D204B] hover:bg-[#6F76C8] cursor-pointer text-white mt-8 py-5 px-7 rounded-xl z-10">
                ...
                <div className="flex flex-row lg:flex-col justify-between lg:justify-start items-center lg:items-start">
                  <h1 className="text-2xl lg:text-5xl lg:mb-3">32hrs</h1>
                  <p className="text-sm text-gray-300">Last Week - 36hrs</p>
                </div>
              </div>
            </div>
            <div className="flex flex-col w-64 justify-end bg-[#FF5E7D] rounded-t-xl rounded-b-2xl relative">
              <svg
                className="absolute top-0 right-5 z-0"
                width="79"
                height="79"
            ...
            <div className="flex flex-col w-64 justify-end bg-[#4BCF83] rounded-t-xl rounded-b-2xl relative">
              <svg
                className="absolute top-0 right-5 z-0"
                width="79"
                height="79"
            ...
            <div className="flex flex-col w-64 justify-end bg-[#7235D1] rounded-t-xl rounded-b-2xl relative">
              <svg
                className="absolute top-0 right-5 z-0"
                width="79"
                height="79"
            ...
            <div className="flex flex-col w-64 justify-end bg-[#F1C75B] rounded-t-xl rounded-b-2xl relative">
              <svg
                className="absolute top-0 right-5 z-0"
                width="79"
                height="79"
              ...
              <div className="flex flex-col lg:h-48 bg-[#1D204B] hover:bg-[#6F76C8] cursor-pointer text-white mt-8 py-5 px-7 rounded-xl z-10">
                ...
                <div className="flex flex-row lg:flex-col justify-between lg:justify-start items-center lg:items-start">
                  <h1 className="text-2xl lg:text-5xl xl:mb-3">32hrs</h1>
                  <p className="text-sm text-gray-300">Last Week - 36hrs</p>
                </div>
              </div>
            </div>
